...
import 'package:flutter_codekk/entity/base_entity.dart';
...
Future<OpEntity> fetchOp(int page, String type) async {
  ...
  return OpEntity.fromJson(BaseEntity.checkEntity(json.decode(response.body)));
}
...
Future<OpSearchEntity> fetchOpSearch(String search, int page) async {
  ...
  return OpSearchEntity
      .fromJson(BaseEntity.checkEntity(json.decode(response.body)));
}
...
Future<OpaEntity> fetchOpa(int page) async {
  ...
  return OpaEntity.fromJson(BaseEntity.checkEntity(json.decode(response.body)));
}
...
Future<JobEntity> fetchJob(int page) async {
  ...
  return JobEntity.fromJson(BaseEntity.checkEntity(json.decode(response.body)));
}
