...
Future<OpSearchEntity> fetchOpSearch(String search, int page) async {
  ...
  return OpSearchEntity.fromJson(json.decode(response.body));
}
...
Future<OpaEntity> fetchOpa(int page) async {
  ...
  return OpaEntity.fromJson(json.decode(response.body));
}
...
Future<BlogEntity> fetchBlog(int page) async {
  ...
  return BlogEntity.fromJson(json.decode(response.body));
}
...
Future<JobEntity> fetchJob(int page) async {
  ...
  return JobEntity.fromJson(json.decode(response.body));
}
...
Future<ReadmeEntity> fetchReadme(ApiType apiType, String id) async {
  ...
  return ReadmeEntity.fromJson(json.decode(response.body));
}
...
Future<RecommendEntity> fetchRecommend(int page) async {
  ...
  return RecommendEntity.fromJson(json.decode(response.body));
}
...
Future<RecommendSearchEntity> fetchRecommendSearch(
  ...
  return RecommendSearchEntity.fromJson(json.decode(response.body));
}
