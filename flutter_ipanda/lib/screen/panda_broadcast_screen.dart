...
class PandaBroadcastState extends ListState<PandaBroadcastScreen, Object> {
  @override
                  ...
                  child: Column(children: <Widget>[
                    ...
                    Expanded(
                        child: Align(
                            ...
                            child: Text(entity.focusDate.toString(),
  ...
  Future<Null> onRefresh() async {
    ...
    fetchBroadcastEntity().then((entity) {
      fetchBroadcastListEntity(entity.listUrl).then((listEntity) {
        list = [];
